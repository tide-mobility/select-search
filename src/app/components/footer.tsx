...
const Footer: React.FC = () => {
  ...
  const searchHref = typeof window !== 'undefined' ? `${window.location.origin}/search` : '/search';
  const searchSabreHref = typeof window !== 'undefined' ? `${window.location.origin}/search-sabre` : '/search-sabre';
    return (
